...
// CPlusExDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "CPlusEx.h"
#include "CPlusExDlg.h"
...
CCPlusExDlg::CCPlusExDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CPLUSEX_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CCPlusExDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CCPlusExDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CCPlusExDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CCPlusExDlg::OnQueryDragIcon()
{
...
void CCPlusExDlg::OnBnClickedBtnbind01()
{
	Learning oo;
	oo.A00_Call();
...
void CCPlusExDlg::OnBnClickedBtnbind2()
{
	//참조자 
	Learning oo;
	//oo.A01_Call();
